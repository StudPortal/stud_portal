...
class UniversitiesControllerTest < ActionController::TestCase
  ...
  test "should create university" do
    assert_difference('University.count') do
      post :create, university: { adress: @university.adress, lat: @university.lat, lng: @university.lng, name: @university.name }
    end
  ...
  test "should update university" do
    patch :update, id: @university, university: { adress: @university.adress, lat: @university.lat, lng: @university.lng, name: @university.name }
    assert_redirected_to university_path(assigns(:university))
  end
